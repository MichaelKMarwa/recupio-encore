...
('clothing', 'Clothing', 'Shirt', 'Clothing items like shirts, pants, and shoes', NOW(), NOW()),
('furniture', 'Furniture', 'Sofa', 'Furniture items like sofas, tables, and chairs', NOW(), NOW()),
('electronics', 'Electronics', 'Smartphone', 'Electronic devices like smartphones, laptops, and tablets', NOW(), NOW()),
('kitchenware', 'Kitchenware', 'Utensils', 'Kitchen items like pots, pans, and utensils', NOW(), NOW()),
('books', 'Books', 'BookOpen', 'Books including hardcover, paperback, and textbooks', NOW(), NOW()),
('toys', 'Toys', 'Gamepad2', 'Toys including action figures, board games, and puzzles', NOW(), NOW()),
('homegoods', 'Home Goods', 'Lamp', 'Home goods like decorations, frames, and lamps', NOW(), NOW()),
('sportsgear', 'Sports Gear', 'Dumbbell', 'Sports equipment like bicycles, weights, and camping gear', NOW(), NOW())
